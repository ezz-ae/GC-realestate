  ...
  return (
    <Card className="rounded-[2rem] border-primary/20 bg-primary/5">
      <CardHeader className="flex flex-row items-center justify-between pb-3">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-2xl gold-gradient shadow-lg shadow-primary/20">
          ...
          <Tabs defaultValue="whatsapp" className="space-y-4">
            ...
            <TabsContent value="whatsapp" className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  className="gold-gradient rounded-xl gap-2 font-bold shadow-md shadow-primary/20"
