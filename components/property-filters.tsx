...
export function PropertyFilters() {
  ...
  return (
    <div className="space-y-6 rounded-lg border border-border bg-card p-6">
      ...
      <div>
        ...
        <div className="mt-2 flex gap-2">
          <Button
            ...
            className={currency === "AED" ? "gold-gradient" : ""}
          >
            AED
          </Button>
          <Button
            ...
            className={currency === "USD" ? "gold-gradient" : ""}
          >
            USD
          </Button>
        </div>
        ...
        <div className="mt-2 flex flex-wrap gap-2">
          {["Studio", "1", "2", "3", "4", "5+"].map(bed => (
            <Button
              ...
              className={bedrooms.includes(bed) ? "gold-gradient" : ""}
            >
              {bed}
            </Button>
          ))}
      ...
      <Button className="w-full gold-gradient" onClick={applyFilters}>
        Apply Filters
      </Button>
    </div>
  )
