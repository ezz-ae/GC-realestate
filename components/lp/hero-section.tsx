      ...
      <div className="container relative z-10 py-16 md:py-24">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          <div className="max-w-2xl space-y-7 text-white">
            <Badge className="gold-gradient border-none px-3 py-1 text-[10px] font-bold uppercase tracking-[0.18em]">
              {eyebrow}
            </Badge>
            ...
            <div className="flex flex-wrap items-center gap-x-5 gap-y-2 rounded-2xl border border-white/10 bg-white/5 px-5 py-3.5 backdrop-blur-sm">
              ...
              <div className="text-sm text-white/75">Gold Century Brokerage · Dubai</div>
              <div className="hidden h-4 w-px bg-white/20 sm:block" />
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <Button
                asChild
                size="lg"
                className="gold-gradient rounded-xl px-8 font-bold shadow-lg shadow-primary/30 text-primary-foreground"
              >
