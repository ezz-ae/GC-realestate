        ...
        {submitted ? (
          <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-5 text-emerald-300">
            ...
            <p className="mt-1 text-sm text-emerald-200/90">
              A Gold Century consultant will contact you shortly with live availability and pricing.
            </p>
          </div>
        ) : (
          <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <Button type="submit" className="gold-gradient w-full" disabled={isSubmitting}>
