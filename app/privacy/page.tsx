...
export const metadata: Metadata = {
  title: "Privacy Policy · Gold Century Real Estate",
  description:
    "Gold Century Real Estate protects investor data with Entrestate Intelligence. Review how we collect, use, and safeguard your information.",
}
