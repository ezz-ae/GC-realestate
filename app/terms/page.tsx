...
export const metadata: Metadata = {
  title: "Terms of Service · Gold Century Real Estate",
  description:
    "Review the terms that govern your use of Gold Century's investor platform, chat, and data services powered by Entrestate Intelligence.",
}

const termsItems = [
  {
    title: "Use of platform",
    body: "Gold Century provides curated Dubai market intelligence, chat, and tools for registered investors. Access to each feature is governed by tier-specific entitlements.",
  },
  {
    title: "Data accuracy",
    ...
    <div className="flex min-h-screen flex-col bg-background">
      <section className="border-b border-border bg-gradient-to-b from-background to-muted py-20">
        <div className="container">
          <Badge variant="secondary" className="gold-gradient">
            Terms
          </Badge>
          <h1 className="mt-4 font-serif text-4xl font-bold tracking-tight">Terms of Service</h1>
          <p className="mt-4 text-lg text-muted-foreground max-w-3xl">
            These terms explain how you may interact with Gold Century Real Estate and the Entrestate Intelligence tools embedded across the platform.
          </p>
        </div>
      </section>
