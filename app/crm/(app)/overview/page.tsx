...
import { getDashboardOverviewData, getUserAccessList, resolveAccessRole } from "@/lib/entrestate"
      ...
      <section className="rounded-3xl border border-border bg-card/70 p-6 shadow-sm">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div className="space-y-2">
            <Badge className="gold-gradient border-none px-3" variant="secondary">
              CRM Command
            </Badge>
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          {availableTabs.map((tab) => (
            <Button
              ...
              className={activeTab === tab.key ? "gold-gradient" : ""}
              asChild
            >
