...
const fallbackDrafts = (input: {
  ...
  return {
    whatsapp: `Hi ${input.leadName}, this is Gold Century. I’m following up on your inquiry. I have details for ${projectLine}.${roiLine} If you want, I can send the brochure, payment plan, and current availability.`,
    emailSubject: `Your Gold Century project update`,
    emailBody: `Hi ${input.leadName},

Thank you for your interest in Gold Century.
