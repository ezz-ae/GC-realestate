                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-3">
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">62%</div>
                        <div className="text-sm text-muted-foreground">Market Share</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">15,180</div>
                        <div className="text-sm text-muted-foreground">Transactions (Q4)</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">+18%</div>
              ...
              <TabsContent value="secondary" className="mt-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-3">
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">35%</div>
                        <div className="text-sm text-muted-foreground">Market Share</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">8,575</div>
                        <div className="text-sm text-muted-foreground">Transactions (Q4)</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">+6%</div>
                        <div className="text-sm text-muted-foreground">YoY Growth</div>
                      </div>
                    </div>
                    <div className="pt-4 border-t">
              ...
              <TabsContent value="commercial" className="mt-6">
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-3">
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">3%</div>
                        <div className="text-sm text-muted-foreground">Market Share</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">745</div>
                        <div className="text-sm text-muted-foreground">Transactions (Q4)</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold gold-text-gradient">+12%</div>
                        <div className="text-sm text-muted-foreground">YoY Growth</div>
                      </div>
                    </div>
                    <div className="pt-4 border-t">
