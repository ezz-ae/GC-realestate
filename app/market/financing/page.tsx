          ...
          <div className="container">
            <div className="grid gap-6 md:grid-cols-4">
              <div className="text-center">
                <div className="text-2xl font-bold gold-text-gradient">50-80%</div>
                <div className="text-sm text-muted-foreground">Loan-to-Value</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold gold-text-gradient">4-6%</div>
                <div className="text-sm text-muted-foreground">Interest Rates</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold gold-text-gradient">25 Years</div>
                <div className="text-sm text-muted-foreground">Max Term</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold gold-text-gradient">15+</div>
              ...
              <Card>
                <CardContent className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="rounded-lg gold-gradient p-6 text-center">
